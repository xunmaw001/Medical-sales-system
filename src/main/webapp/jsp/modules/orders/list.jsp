										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="orderidTh" class="sorting" onclick="sort('orderid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">订单id</th>
																													...
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">商品图片</th>
																																																			...
																																																			<th id="typeTh" class="sorting" onclick="sort('type')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">支付类型（1：现金 2：积分）</th>
