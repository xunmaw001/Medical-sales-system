...
<body>
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/discussyongyaozhinan/list.jsp">用药指南评论表</a>
							</li>
						</ul>
					</div>
					<div class="row">
	...
	<script>
		...
		var tableName = "discussyongyaozhinan";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "discussyongyaozhinan/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("discussyongyaozhinan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("discussyongyaozhinan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
		...
		function calculationSE(colName){
			//单列求和接口
			http("discussyongyaozhinan"+colName,"GET",{
				tableName: "discussyongyaozhinan",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
