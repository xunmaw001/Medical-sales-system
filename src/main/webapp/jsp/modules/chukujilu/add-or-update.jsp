									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<input id="yaopinbianhao" name="yaopinbianhao" class="form-control" placeholder="药品编号">
												</div>	
											<div class="form-group">
												<label>药品名称</label>
											...
											<div class="form-group">
												...
												<input id="yaopinleixing" name="yaopinleixing" class="form-control" placeholder="药品类型">
												</div>	
											<div class="form-group">
												<label>药品库存</label>
	...
	<script>
       ...
       //跨表
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.yaopinkucun != null && res.data.yaopinkucun != ''){
															...
															yaopinkucunKucun = res.data.yaopinkucun;
		...
		function crossTableUpdate(){
			...
			if(flag){
				httpJson(crossTableName + "/update","POST",{
					id: crossTableId,
																																																			yaopinkucun: crossRuleForm.yaopinkucun - $('#yaopinkucun').val(),	
																										},(res)=>{
					if(res.code == 0){
						console.log('跨表更新成功');
						return true;
		...
		function crossTableUpdateValidation(){
			//防止减法导致库存负值
																																	if(yaopinkucunKucun < $('#yaopinkucun').val()){
						alert('药品库存不能大于'+yaopinkucunKucun+'！请重新输入');
						return false;
					}
																	return true;
		}
