									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="zhinanbiaoti" v-model="ruleForm.zhinanbiaoti" readonly>
																							</div>
												...
												<input type="hidden" id="buliangfanying-input">
											</div>
																																																													<div class="form-group">
												<label>用法用量</label>
												<script id="yongfayongliangEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var yongfayongliangUe = UE.getEditor('yongfayongliangEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="yongfayongliang-input">
											</div>
																																																													<div class="form-group">
												<label>用药指南</label>
												...
												<input type="hidden" id="yongyaozhinan-input">
											</div>
																																																																																																																								</form>
										</div>
									</div>
		...
		function setContent(){
					...
					buliangfanyingUeditor.ready(function() {
						...
						buliangfanyingUeditor.setDisabled('fullscreen');
													...
													if(ruleForm.yongfayongliang != null && ruleForm.yongfayongliang != 'null' && ruleForm.yongfayongliang != ''){
					var yongfayongliangMes = '' + ruleForm.yongfayongliang;
					var yongfayongliangUeditor = UE.getEditor('yongfayongliangEditor');
					yongfayongliangUeditor.ready(function() {
						yongfayongliangUeditor.setContent(yongfayongliangMes);
						yongfayongliangUeditor.setDisabled('fullscreen');
					});
				}
					...
					yongyaozhinanUeditor.ready(function() {
						...
						yongyaozhinanUeditor.setDisabled('fullscreen');
					});
				}
																				}  
