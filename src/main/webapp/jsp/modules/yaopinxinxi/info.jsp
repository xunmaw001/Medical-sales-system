...
<body>
									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="yaopinbianhao" v-model="ruleForm.yaopinbianhao" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>药品名称</label>
																								
																								<input id="yaopinmingcheng" v-model="ruleForm.yaopinmingcheng" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>药品类型</label>
																								
																								<input id="yaopinleixing" v-model="ruleForm.yaopinleixing" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>药品库存</label>
																								
																								<input id="yaopinkucun" v-model="ruleForm.yaopinkucun" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="shiyingzhengzhuang" v-model="ruleForm.shiyingzhengzhuang" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>禁忌症状</label>
																								
																								<input id="jinjizhengzhuang" v-model="ruleForm.jinjizhengzhuang" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="price" v-model="ruleForm.price" readonly>
																																																																																																																																																																																																																																																																																																													...
																																																																																																																																																																																																																																																																																																													<div class="form-group">
												<label>药品成分</label>
												<script id="yaopinchengfenEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var yaopinchengfenUe = UE.getEditor('yaopinchengfenEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" id="yaopinchengfen-input">
											</div>
																																																													<div class="form-group">
												<label>注意事项</label>
												...
												<input type="hidden" id="zhuyishixiang-input">
											</div>
																																																													<div class="form-group">
												<label>药品详情</label>
												...
												<input type="hidden" id="yaopinxiangqing-input">
											</div>
																																																																																																																																																																</form>
										</div>
									</div>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
																																																				if(ruleForm.yaopinchengfen != null && ruleForm.yaopinchengfen != 'null' && ruleForm.yaopinchengfen != ''){
					var yaopinchengfenMes = '' + ruleForm.yaopinchengfen;
					var yaopinchengfenUeditor = UE.getEditor('yaopinchengfenEditor');
					yaopinchengfenUeditor.ready(function() {
						yaopinchengfenUeditor.setContent(yaopinchengfenMes);
						yaopinchengfenUeditor.setDisabled('fullscreen');
					});
				}
