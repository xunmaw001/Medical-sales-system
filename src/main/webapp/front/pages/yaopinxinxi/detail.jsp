				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>适应症状：</span>
							<span class="desc">
								{{detail.shiyingzhengzhuang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>禁忌症状：</span>
							<span class="desc">
								{{detail.jinjizhengzhuang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>药品成分：</span>
							<span class="desc">
								{{detail.yaopinchengfen}}
							</span>
						</div>
																								<div class="detail-item">
							<span>注意事项：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('yaopinxinxi','入库')" @click="onAcrossTap('rukujilu')" type="button" class="layui-btn">
								入库
							</button>
																					<button v-if="isAuth('yaopinxinxi','出库')" @click="onAcrossTap('chukujilu')" type="button" class="layui-btn">
								出库
							</button>
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					vue.detail = res.data
																									vue.title = vue.detail.yaopinmingcheng;
																																								// 轮播图片
					vue.swiperList = vue.detail.yaopintupian ? vue.detail.yaopintupian.split(",") : [];
																																																																																															var swiperItemHtml = '';
