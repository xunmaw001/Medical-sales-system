	...
	<body>
		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<div style="text-align: center;margin-top: 20px;">
					<button @click="jump('../yongyaozhinan/list.jsp')" type="button" class="layui-btn layui-btn-primary">查看更多>></button>
				</div>
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../yongyaozhinan/detail.jsp?id='+item.id)" class="data-item layui-col-md3"  v-for="(item,index) in yongyaozhinanList" v-bind:key="index" v-if="item">
																																																						
						<img class="cover" :src="item.fengmiantupian?item.fengmiantupian.split(',')[0]:''">
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
				...
				http.request('news/list', 'get', {
					...
					vue.yaopinxinxiList = res.data.list
                                                                                                                                ...
                                                                                                                                http.request(`yongyaozhinan/list?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
					vue.yongyaozhinanList = res.data.list
				});
